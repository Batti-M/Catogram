<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
        ...
        <div>
            ...
            <input type="file" id="profile_image" name="profile_image" type="text" class="mt-1 block w-full text-gray-200" :value="old('profile_image', $user->profile_image)" autofocus autocomplete="profile_image" />
